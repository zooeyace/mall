...
public class GiteeUtil {
     ...
     * 码云私人令牌
     */
    public static final String ACCESS_TOKEN = "188a11858d9034ef701fe2272c8a4d1a";

    /**
     * 码云个人空间名
     */
    public static final String OWNER = "zooeyace";
     ...
     * 上传时指定存放图片路径
     */
    public static final String PATH = "/upload-img/" + DateUtil.getDate() + "/";
    ...
    public static String createUploadFileUrl(String originalFilename) {
        ...
        //填充请求路径
        return String.format(GiteeUtil.API_CREATE_POST,
                GiteeUtil.OWNER,
                GiteeUtil.REPO,
                GiteeUtil.PATH + fileName);
    }
    ...
    public static Map<String, Object> getUploadBodyMap(byte[] multipartFile) {
        ...
        bodyMap.put("access_token", GiteeUtil.ACCESS_TOKEN);
        bodyMap.put("message", GiteeUtil.ADD_MESSAGE);
